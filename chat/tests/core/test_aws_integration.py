...
print(s3_client.list_objects(Bucket="consultor-juridico"))
...
def run_tests():
    ...
    try:
        ...
        docs = process_pdf_from_s3(TEST_BUCKET, f"{TEST_FILE}")
    ...
    try:
        ...
        all_docs = process_all_pdfs_in_bucket(TEST_BUCKET, TEST_PREFIX)
