...
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| **KATCILANE** | Terraform (Infraestrutura Base, EC2), Desenvolvimento da API (Flask/FastAPI)  [inserir link do .md do integrante das suas atividades desenvolvidas](https://github.com/Compass-pb-aws-2025-JANEIRO/sprints-7-8-pb-aws-janeiro)      | AWS, Terraform, Python          |
